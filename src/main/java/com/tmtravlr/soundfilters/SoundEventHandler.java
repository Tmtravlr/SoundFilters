...
/**
 * This class handles the sound events, specifically when sounds start
 * playing. It adds the sounds to the source map. Created to solve the
 * "random movements" problem that happened occasionally.
 * 
 * @author Rebeca Rey
 * @Date 2014
 */
public class SoundEventHandler
{
    ...
    /**
     * Finds the occlusion amount for the given location, and adds a new source to
     * the sourceOccusionMap, with the source as null (will get set to the actual source
     * the first time it runs through the SoundTickHandler).
     * 
